...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='MNIST', help='dataset') # dataset --- MNIST: MNIST, MHIST: MHIST
    parser.add_argument('--model', type=str, default='ConvNet', help='model') # model
    parser.add_argument('--ipc', type=int, default=10, help='image(s) per class') # images / class --- MNIST: 10, MHIST: 50
    parser.add_argument('--eval_mode', type=str, default='M', help='eval_mode') 
    parser.add_argument('--num_exp', type=int, default=1, help='the number of experiments')
    parser.add_argument('--num_eval', type=int, default=100, help='the number of evaluating randomly initialized models') # k --- MNIST: 100, MHIST:200
    parser.add_argument('--epoch_eval_train', type=int, default=50, help='epochs to train a model with synthetic data') # zeta_theta
    parser.add_argument('--Iteration', type=int, default=10, help='training iterations') # t
    parser.add_argument('--lr_img', type=float, default=0.1, help='learning rate for updating synthetic images, 1 for low IPCs 10 for >= 100') # eta_s
    parser.add_argument('--lr_net', type=float, default=0.01, help='learning rate for updating network parameters') # eta_theta
    parser.add_argument('--batch_real', type=int, default=256, help='batch size for real data') # minibatch size --- MNIST: 256, MHIST: 128
    parser.add_argument('--batch_train', type=int, default=256, help='batch size for training networks') # minibatch size --- MNIST: 256, MHIST:128
    parser.add_argument('--init', type=str, default='real', help='noise/real/smart: initialize synthetic images from random noise or randomly sampled real images.') # initialization of images --- b, c: real, d: noise
    parser.add_argument('--dsa_strategy', type=str, default='color_crop_cutout_flip_scale_rotate', help='differentiable Siamese augmentation strategy')
    parser.add_argument('--data_path', type=str, default='./DataDAM/mnist_dataset/', help='dataset path')
    parser.add_argument('--zca', type=bool, default=False, help='Zca Whitening')
    parser.add_argument('--save_path', type=str, default='./DataDAM/task_1_3/', help='path to save results')
    parser.add_argument('--task_balance', type=float, default=0.01, help='balance attention with output') # task balance parameter
