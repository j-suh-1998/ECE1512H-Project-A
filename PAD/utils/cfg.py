...
CFG.epoch_eval_train = 50

# how many distillation steps to perform
CFG.Iteration = 10

# Learning rates
CFG.lr_img = 0.1  # learning rate for updating synthetic images
...
CFG.pix_init = 'real'  # initialize synthetic images from random noise or real images
...
CFG.buffer_path = '../buffer/buffers/'  # buffer path
...
# ZCA whitening
CFG.zca = False  # do ZCA whitening (use True if action='store_true')
