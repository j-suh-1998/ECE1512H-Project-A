...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_teacher', type=float, default=0.1, help='initialization for synthetic learning rate')
    parser.add_argument('--no_aug', type=bool, default=False, help='this turns off diff aug during distillation')
    parser.add_argument('--batch_train', type=int, default=256, help='batch size for training networks')

    parser.add_argument('--parall_eva', type=bool, default=False, help='dataset')

    parser.add_argument('--data_dir', type=str, default='./logged_files/MNIST/10/ConvNet/stilted-glitter-4/Normal/images_0.pt', help='dataset')
    parser.add_argument('--label_dir', type=str, default='./logged_files/MNIST/10/ConvNet/stilted-glitter-4/Normal/labels_0.pt', help='dataset')
    parser.add_argument('--lr_dir', type=str, default='./logged_files/MNIST/10/ConvNet/stilted-glitter-4/Normal/lr_0.pt', help='dataset')
