...
def prepare_args():
    ...
    parser.add_argument('--dataset', type=str, default='synthetic', help='dataset')
    ...
    parser.add_argument('--num_eval', type=int, default=100, help='the number of evaluating randomly initialized models')
    ...
    parser.add_argument('--eval_gap', type=int, default=10, help='run evaluation every eval_gap epochs.')
